...
from semantics.relation import BehindRelation
...
if __name__ == '__main__':
	...
	for i in range(args.iterations):
		...
		original_lmk = lmk
		while isinstance(rel, BehindRelation):
			lmk, rel, head_on = speaker.sample_meaning(trajector, scene, max_level=1, leave_out=BehindRelation)
		lmk = original_lmk
